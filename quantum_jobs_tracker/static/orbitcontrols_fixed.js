/**
 * OrbitControls - Non-module version for direct script loading
 * Based on Three.js OrbitControls but without ES6 imports
 */
...
(function() {
    ...
    if (typeof THREE === 'undefined') {
        console.error('THREE is required for OrbitControls');
        return;
    }
    ...
    var OrbitControls = function ( object, domElement ) {
        ...
        // this method is exposed, but it should probably be called as an internal method
        ...
        function onMouseDown( event ) {
            ...
            var mouseAction = scope.mouseButtons[ event.button ];
